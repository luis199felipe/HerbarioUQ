...
@NamedQueries({
		...
		@NamedQuery(name = RegistroEspecie.TRABAJADOR_GET_REGISTERS, query = "select new co.alfite.sis.DTO(registro.trabajador.idPersona,count(registro)) from RegistroEspecie registro  group by registro.trabajador.idPersona "),
